...
//:
//evaluate  [ɪˈvæljueɪt] 评价;求…的值
//executing  履行;执行  execute的现在分词
//a certain condition 一定的条件
//certain 某一;   必然的;   已确定的;
//clause 从句，分句;条款，款项
//chain 用铁链锁住;监禁，束缚
let number = 23
...
//pattern 模式
//exhaustive [ɪgˈzɔ:stɪv] 详尽的
//satisfied [ˈsætɪsfaɪd] 满意的，满足的;清偿过的;确信的，毫无疑问的
//: > **Experiment**:
