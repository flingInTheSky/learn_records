...
//:
//parentheses [pəˈrenθəsi:z]  圆括号
//backslash [ˈbækslæʃ] 反斜杠
//interpolation [ɪnˌtɜ:pə'leɪʃn] 窜改;添写，插补
let apples = 3
let oranges = 5
...
//:
//疑问：当后面带有值，是不是就一定不为niu了？因为是let声明。？
...
//:
//pervasive  [pəˈveɪsɪv] 普遍的
//present 现在的;   目前的;   出席的   (在这里的意思应该是不存在)
var myString = "7"
...
//individual [ˌɪndiˈvidjuəl] 个人的;   独特的;   个别的; 
//pieces of code 代码块
//slashes 斜杠
//asterisks ['æstərɪsks] 星号
//exclamation  [ˌekskləˈmeɪʃn] 感叹
//is assumed to 假定
var implicitlyUnwrappedOptionalInt: Int!
//rarely  [ˈreəli] 很少地;罕有地;
// keep track of  与…失去[保持]联系，了解[忘记];  
//outlets  出口
