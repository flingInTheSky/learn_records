...
//:
//: Your first lesson is presented in the form of a guided Swift _playground_, a type of file that lets you change and interact with the code directly in Xcode and see the result immediately. Playgrounds are great for learning and experimenting, and this one helps get you up to speed on fundamental Swift concepts.
//:
//: ## Learning Objectives
//:
...
//: 
//: [Next](@next)
//preliminary  [prɪˈlɪmɪnəri]  初步的，初级的;
//adoption [əˈdɒpʃn] 采用，收养
//subject to 容易遭受 受。。管制
//operating 操作
//Essentials  [ɪ'senʃlz]要领;要素;
//interact 互动
//experimenting 做实验，进行试验
//fundamental [ˌfʌndəˈmentəl] 基础的，基本的
//concepts 概念
//implicit 隐式 explicit显式 declarations 声明
//clauses 从句
//impose 强加;
//syntax 句法
...
//疑问 
//Differentiate between optionals and implicitly unwrapped optionals  什么意思