...
//:
//oriented 导向的;   以…为方向的;   定向的;   定方
//In object-oriented programming  在面向对象的程序设计
//interactions 一起活动( interaction的名词复数 );   合作;   互相影响;   互动;  
//blueprint 蓝图，设计图;计划大纲;原本
//Likewise 同样地;也，而且
class Shape {
    var numberOfSides = 0
...
//distinguish [dɪˈstɪŋgwɪʃ] 区分，辨别，分清;辨别是非
...
//:
//quite a few 相当多
//associated 合伙，合营;联合，结合;联想
//designated 指定的，选定的;  
//primary 首要的，主要的; 
//ultimately  ['ʌltimətli] 最后，最终;   基本上;   根本;   郅;  
//respectively   [rɪˈspektɪvli]  各自地;各个地;分别地
//Type casting 类型转换  casting 扔掉(cast的现在分词);   铸造;   投掷;   选派演员;  
//treat [tri:t] 治疗;对待;处理;款待  treat as当做;看成;把。。。看作。。。;当
//downcast 向下的
//trigger 引发，触发
//increment [ˈɪŋkrəmənt] 增量;增长
//corresponding [ˌkɒrəˈspɒndɪŋ] 相当的，对应的
